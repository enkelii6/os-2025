    ...
    if (marks == NULL) {
        ...
        do {
            ...
            if (ans == 1) {
                ...
                // Dynamically re-allocate memory by using realloc - check if the memory is successfully
                ...
                if (marks == NULL) {
                    ...
                    printf("\n base address of marks are:%pc", marks);  // print base or beginning address of allocated memory
                }
            }
        } while (ans == 1);
